...
/**You should use this struct via [`GmailClient::settings_send_as_patch`].

On request success, this will return a [`SettingsSendAsPatchResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SettingsSendAsPatchRequest {
...
impl SettingsSendAsPatchRequest {}
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, SettingsSendAsPatchRequest> {
    type Output = httpclient::InMemoryResult<SettingsSendAsPatchResponse>;
