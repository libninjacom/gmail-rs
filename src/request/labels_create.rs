...
/**You should use this struct via [`GmailClient::labels_create`].

On request success, this will return a [`LabelsCreateResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LabelsCreateRequest {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, LabelsCreateRequest> {
    type Output = httpclient::InMemoryResult<LabelsCreateResponse>;
