...
/**You should use this struct via [`GmailClient::labels_patch`].

On request success, this will return a [`LabelsPatchResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LabelsPatchRequest {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, LabelsPatchRequest> {
    type Output = httpclient::InMemoryResult<LabelsPatchResponse>;
